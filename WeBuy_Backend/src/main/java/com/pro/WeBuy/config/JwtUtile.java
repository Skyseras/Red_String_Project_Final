...
public class JwtUtile {
    ...
    private String jwtSingningKey = "secretsecretsecretsecretsecret";
    ...
    public ResponseDto generateToken(User appUser) {
        Map<String, Object> claims = new HashMap<>();
        return createToken(claims,appUser);
    }

    public ResponseDto createToken(Map<String,Object> claims, User userDetails){
